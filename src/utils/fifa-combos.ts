// Auto-generated from official FIFA 2026 World Cup regulations Annex C
// 495 possible combinations of which 8 third-placed teams advance
// Key: sorted string of 8 groups whose 3rd-placed teams qualified
// Value: array of 8 group letters mapped to R32 matches
//   index 0 → match m79 (1A vs: W_A vs 3rd)
//   index 1 → match m85 (1B vs: W_B vs 3rd)
//   index 2 → match m81 (1D vs: W_D vs 3rd)
//   index 3 → match m74 (1E vs: W_E vs 3rd)
//   index 4 → match m82 (1G vs: W_G vs 3rd)
//   index 5 → match m77 (1I vs: W_I vs 3rd)
//   index 6 → match m87 (1K vs: W_K vs 3rd)
//   index 7 → match m80 (1L vs: W_L vs 3rd)

export const THIRD_PLACE_COMBOS: Record<string, readonly string[]> = {
