...
insert into public.scoring_rules (rule_key, pts, description) values
  ...
  ('ko_reach_r32',           2,  'Team correctly predicted in R32'),
  ('ko_reach_r16',           5,  'Team correctly predicted in R16'),
  ('ko_reach_qf',           10,  'Team correctly predicted in QF'),
  ('ko_reach_sf',           15,  'Team correctly predicted in SF'),
  ('ko_reach_final',        20,  'Team correctly predicted in Final'),
